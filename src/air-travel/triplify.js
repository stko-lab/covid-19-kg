...
let h_countries = {};
{
	...
	for(let g_country of A_COUNTRIES) {
		...
		ds_writer.write({
			type: 'c3',
			value: {
				[`covid19-region:${g_country.codeIso2Country}`]: {
					a: 'covid19:Region',
			...
			ds_writer.write({
				...
				value: {
					[`covid19-airline:${si_airline}`]: {
						...
						'covid19:region': `covid19-region:${g_airline.codeIso2Country}`,
					},
				},
			});
		}
	...
	ds_writer.write({
		...
		value: {
			[sc1_route]: {
				...
				'covid19:departsRegion': 'covid19-region:'+si_departure_country,
				'covid19:arrivesRegion': 'covid19-region:'+si_arrival_country,
